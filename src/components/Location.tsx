...
export default function Location() {
    return (
        <div className="flex w-full max-w-[617px] flex-col items-start gap-8 shrink-0 self-stretch">
            ...
            <div className="flex flex-col w-full min-h-[280px] h-[320px] sm:h-[400px] lg:h-[448px] p-4 justify-center items-center gap-4 rounded-xl bg-[#0D1117] overflow-hidden"> 
