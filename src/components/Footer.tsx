  ...
  return (
    <footer className="w-full border-t border-white/5 bg-[#080A0F] pt-20 pb-10 px-12 lg:px-32">
      <div className="flex flex-col w-full max-w-[1152px] mx-auto gap-16">
        <div className="flex justify-between items-start w-full gap-40 lg:gap-80 xl:gap-[28rem]">
          {/* Left: Logo and name */}
          <div className="flex items-center gap-2">
            <div className="p-2 rounded-lg bg-[#1152D4]/20">
              <Image
            ...
            <span className="text-slate-100 text-xl font-extrabold leading-7 tracking-tight uppercase">
              MM Barber
            </span>
          </div>
          ...
          <div className="flex flex-col items-start gap-6 flex-1 ">
            <div className="flex flex-col gap-6 self-stretch">
              ...
              <div className="flex gap-4 self-stretch">
                <a
                  href="https://instagram.com/mmbarber"
                  target="_blank"
                ...
                <a
                  href="https://tiktok.com/@mmbarber"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex w-10 h-10 justify-center items-center rounded-full border border-white/5 bg-[#0F131A] hover:bg-white/5 transition-colors"
                >
            ...
            {/* Book now button */}
            <Button2 href="https://www.fresha.com/a/mm-barber-asse-kalkoven-9-ofd64t6n" size="lg">Book now</Button2>
          </div>
        </div>
